...
extern "C"{
	...
	LPXLOPER EXCEL_EXPORT xlInterp1D(XlfOper xlInX, XlfOper xlInY, XlfOper xlOutX, XlfOper xlInterpMethod);
	...
	LPXLOPER EXCEL_EXPORT xlInterpMonotonicNaturalBSpline(XlfOper xlInX, XlfOper xlInY, XlfOper xlOutX);
