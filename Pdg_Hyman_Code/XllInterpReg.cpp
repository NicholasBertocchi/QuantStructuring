...
int PDGInterpReg(void)
{
  ...
  { // xlInterpKruger(xlInX, xlInY, xlOutX)
    ...
    { // xlInterpKruger(xlInX, xlInY, xlOutX)
    XlfFuncDesc InterpMonotoneCubicSpline("xlInterpMonotoneCubicSpline",XLFUNCNAME(InterpMonotoneCubicSpline),"Returns an array containing the cubic hyman filtered interpolation points relative to the outX coordinates","PDGInterp");
    XlfArgDesc InX("InX","Array of input X coordinates");
    XlfArgDesc InY("InY","Array of input Y coordinates");
    XlfArgDesc OutX("OutX","Array of output X coordinates");
    InterpMonotoneCubicSpline.SetArguments(InX+InY+OutX);
    InterpMonotoneCubicSpline.Register();
  } // END xlInterpMonotoneCubicSpline
